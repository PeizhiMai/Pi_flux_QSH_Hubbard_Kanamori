...
const SMOQYDQMC_CORE_ONLY = lowercase(get(ENV, "SMOQYDQMC_CORE_ONLY", "false")) in ("1", "true", "yes", "y")
...
############################
## KANAMORI DENSITY MODEL ##
############################

# Define density-density/Ising-Hund inter-orbital Kanamori model
include("Kanamori/KanamoriDensityModel.jl")
export KanamoriDensityModel, KanamoriDensityParameters, measure_kanamori_density_energy

# Define spin-channel Hirsch HS transformation for density-density Kanamori terms
include("Kanamori/KanamoriDensityHirschHST.jl")
export KanamoriDensityHirschHST

# Define generic local matrix fast-update helpers needed by off-diagonal Hund fields
include("Kanamori/LocalMatrixUpdate.jl")
export local_matrix_update_det_ratio, local_matrix_update_greens!

# Define spin-flip Hund HS transformation using off-diagonal orbital fields
include("Kanamori/HundSpinFlipHST.jl")
export HundSpinFlipHST, apply_hund_spinflip_to_propagators!

# Define full Kanamori transverse spin-flip + pair-hopping HS transformation
include("Kanamori/KanamoriTransverseHST.jl")
export KanamoriTransverseHST, apply_kanamori_transverse_to_propagators!
